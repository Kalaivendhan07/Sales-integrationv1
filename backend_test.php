...
class BackendTestSuite {
    ...
    private function testLevel1ValidationCore() {
        ...
        $salesData = array(
            'registration_no' => '29AATEST0001B1Z',
        ...
        echo "  🧪 Testing with existing customer (29AATEST0001B1Z):\n";
    ...
    private function testVolumeDiscrepancyCore() {
        ...
        try {
            ...
            $stmt = $this->db->prepare("SELECT id FROM isteer_general_lead WHERE registration_no = '29AATEST0001B1Z'");
            $stmt->execute();
