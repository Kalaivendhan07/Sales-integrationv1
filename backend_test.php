...
class BackendTestSuite {
    ...
    private function testGSTINValidationLogic() {
        ...
        $testCases = array(
            '29ABCDE0001F1Z5' => true,   // Valid format (15 chars)
            '29XYZAB1234G2Z7' => true,   // Valid format (15 chars)
    ...
    private function testLevel1ValidationCore() {
        ...
        echo "  🧪 Testing with existing customer (29ABCDE0001F1Z5):\n";
    ...
    private function testOpportunityCreation() {
        ...
        $salesData = array(
            'registration_no' => '29AATEST8888C1W',
