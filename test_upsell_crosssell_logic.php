...
$db->exec("UPDATE isteer_general_lead SET integration_managed = 0 WHERE registration_no = '29TESTUP1234F1Z5Q'");
$db->exec("DELETE FROM isteer_general_lead WHERE registration_no = '29TESTUP1234F1Z5Q'");
...
$stmt = $db->prepare("
    INSERT INTO isteer_general_lead (
        ...
        'Test Corp Ltd', '29TESTUP1234F1Z5Q', 'Test DSR', 101,
...
$stmt = $db->prepare("
    INSERT INTO isteer_sales_upload_master (
        ...
        'SHELL_ULTRA_MAIN', 200.00, '29TESTUP1234F1Z5', 'Mainstream'
    )
");
$stmt->execute();
...
$salesData1 = array(
    'registration_no' => '29TESTUP1234F1Z5',
...
$stmt = $db->prepare("SELECT COUNT(*) as count FROM isteer_general_lead WHERE registration_no = '29TESTUP1234F1Z5'");
$stmt->execute();
...
$stmt = $db->prepare("
    ...
    WHERE registration_no = '29TESTUP1234F1Z5'
    ORDER BY id
");
$stmt->execute();
...
$db->exec("UPDATE isteer_general_lead SET integration_managed = 0 WHERE registration_no = '29TESTUP1234F1Z5'");
$db->exec("DELETE FROM isteer_general_lead WHERE registration_no = '29TESTUP1234F1Z5'");
$db->exec("DELETE FROM isteer_opportunity_products WHERE product_id LIKE 'SHELL_%'");
$db->exec("DELETE FROM isteer_sales_upload_master WHERE registration_no = '29TESTUP1234F1Z5'");
